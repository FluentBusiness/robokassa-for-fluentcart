...
add_action( 'plugins_loaded', function() {
    ...
    add_filter('fluentcart/order_more_actions', function ($actions, $order) {
        error_log('Robokassa: Order Admin Actions filter triggered  for Order ID: ' . $order->id);
...
/**
 * Локализация (перевод) плагина
 */
function fluent_robokassa_load_textdomain() {
    load_plugin_textdomain( 'fluent-robokassa', false, dirname( plugin_basename(__FILE__) ) . '/languages/' );
}
add_action( 'plugins_loaded', 'fluent_robokassa_load_textdomain' );
